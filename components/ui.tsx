...
export function CoverageCard({ title, body }: { title: string; body: string }) {
  return (
    <Reveal className="h-full">
      <div className="group h-full rounded-lg border border-slate-200 bg-white p-6 shadow-card transition-all duration-300 hover:-translate-y-1 hover:border-navy hover:shadow-lg">
  ...
  return (
    <section className="bg-navy">
      <Container className="flex flex-col items-start gap-6 py-16 lg:flex-row lg:items-center lg:justify-between lg:py-20">
        ...
        <Reveal className="flex flex-shrink-0 flex-wrap gap-3" delay={120}>
